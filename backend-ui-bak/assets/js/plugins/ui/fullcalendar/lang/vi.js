!function (t, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n(require("moment"), require("fullcalendar")) : "function" == typeof define && define.amd ? define(["moment", "fullcalendar"], n) : "object" == typeof exports ? n(require("moment"), require("fullcalendar")) : n(t.moment, t.FullCalendar)
    ...
    return function (t) {
        ...
        var e = {};
        return n.m = t, n.c = e, n.d = function (t, e, h) {
        ...
        0: function (n, e) {
            ...
            Object.defineProperty(n, "__esModule", {value: !0}), e(202);
            var h = e(1);
            h.datepickerLocale("vi", "vi", {
                ...
                buttonText: {month: "Tháng", week: "Tuần", day: "Ngày", list: "Lịch biểu"}, allDayText: "Cả ngày", eventLimitText: function (t) {
                    return "+ Xem thêm " + t
