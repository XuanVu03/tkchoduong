...
!function (e) {
    e.fn.niceSelect = function (t) {
        ...
        function s(t) {
            t.after(e("<div></div>").addClass("nice-select").addClass(t.attr("class") || "").addClass(t.attr("disabled") ? "disabled" : "").addClass(t.attr("multiple") ? "has-multiple" : "").attr("tabindex", t.attr("disabled") ? null : "0").html(t.attr("multiple") ? '<span class="multiple-options"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Search..."/></div><ul class="list "></ul>' : '<span class="current js-current"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Search..."/></div><ul class="list"></ul>'));
        ...
        this.hide(), this.each(function () {
            ...
            if (13 == t.keyCode) return s.hasClass("open") ? l.trigger("click") : s.trigger("click"), !1;
            if (40 == t.keyCode) {
                if (s.hasClass("open")) {
...
$('<div class="quantity-nav"><div class="quantity-button quantity-up">+</div><div class="quantity-button quantity-down">-</div></div>').insertAfter(".quantity input"), $(".quantity").each(function () {
    var t = jQuery(this), i = t.find('input[type="number"]'), n = t.find(".quantity-up"), a = t.find(".quantity-down"),
...
!function (e) {
    e.fn.jAutoCalc = function (t) {
        var s = {}, u = {
            ...
            for (func in u) for (f = u[func], r = new RegExp(f.rgx, "gi"); null != (m = r.exec(t));) v = f.exec(m[1], a, d), t = t.replace(new RegExp(f.rgx, "gi"), v);
            ...
            "+": {
                op: "+", precedence: 10, assoc: "L", exec: function (e, t) {
                    return e + t
                }
            }, "-": {
                op: "-", precedence: 10, assoc: "L", exec: function (e, t) {
                ...
                op: "*", precedence: 20, assoc: "L", exec: function (e, t) {
                    return e * t
                }
            }, "/": {
                op: "/", precedence: 20, assoc: "L", exec: function (e, t) {
                ...
                op: "**", precedence: 30, assoc: "R", exec: function (e, t) {
                    return Math.pow(e, t)
                }
            }
        }, p = {e: Math.exp(1), pi: 4 * Math.atan2(1, 1)}, y = function (e) {
            var t, r, n = e.offset;
            for (t = 0; "0123456789".indexOf(e.string.substr(e.offset, 1)) >= 0 && e.offset < e.string.length;) e.offset++;
                ...
                return this.each(function () {
                    $ctx = e(this), e("[" + s.attribute + "]:not([_jac])", $ctx).each(function () {
                        if ($this = e(this), eq = $this.attr(s.attribute), fields = a(eq), 0 != fields.length) {
                            for (i = 0; i < fields.length; i++) if (0 == e(l(fields[i]), $ctx).length) return;
    ...
    return function (t) {
        ...
        e(1), function (t) {
            ...
            t.fn.iqDropdown = function (e) {
                function o(t, n) {
                    var e = parseInt(n.data("mincount"), 10), o = parseInt(n.data("maxcount"), 10);
                    u.items[t] = {minCount: isNaN(e) ? 0 : e, maxCount: isNaN(o) ? 1 / 0 : o}
                }
                ...
                function r(n, e, o) {
                    ...
                    return e.children("div").addClass(u.controls.displayCls), r.append(i, a, s), "right" === u.controls.position ? e.append(r) : e.prepend(r), i.click(function (t) {
                        var e = u.items, r = u.minItems, i = u.beforeDecrement, s = u.onChange, c = i(n, l);
                        c && d > r && l[n] > e[n].minCount && (l[n]--, d--, a.html(l[n]), o(), s(n, l[n], d)), t.preventDefault()
                    }), s.click(function (t) {
                        var e = u.items, r = u.maxItems, i = u.beforeIncrement, s = u.onChange, c = i(n, l);
                ...
                function i() {
                    var t = 1 !== d && u.textPlural.length > 0, n = t ? u.textPlural : u.selectionText;
                    s.html(d + " " + n)
                }

                var s = this.find("p").last(), a = this.find("ul"), c = a.find("li"), u = t.extend(!0, {}, n, e),
                    l = {}, d = 0;
                return this.click(function () {
                    s.toggleClass("menu-open"), a.toggleClass("show-menu")
                }), c.each(function () {
                    var n = t(this), e = n.data("id"), s = parseInt(n.data("defaultcount") || "0", 10);
...
;(function (f) {
    ...
    q.prototype = {
        init: function (a) {
            ...
            this.$cache.cont.html('<span class="irs"><span class="irs-line" tabindex="0"><span class="irs-line-left"></span><span class="irs-line-mid"></span><span class="irs-line-right"></span></span><span class="irs-min js-iris-line">0</span><span class="irs-max js-iris-line">1</span><span class="irs-from js-iris-line">0</span><span class="irs-to js-iris-line">0</span><span class="irs-single js-iris-line">0</span></span><span class="irs-grid"></span><span class="irs-bar"></span>');
